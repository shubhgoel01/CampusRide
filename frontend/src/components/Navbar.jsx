    ...
    <header className="sticky top-3 z-40 mx-4 md:mx-8 bg-gradient-to-r from-sky-700 to-indigo-700 text-white shadow-lg rounded-lg">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden sm:flex items-center gap-4">
          <Link
            to="/home"
            className="flex items-center gap-2 text-sky-100 hover:text-white px-3 py-1 rounded hover:bg-white/5"
          >
        ...
        <div className="flex items-center gap-4">
          ...
          {user && (
            <div className="flex items-center gap-3">
              ...
              <div className="bg-white/10 px-2 py-1 rounded text-sm capitalize">
                {user.userType}
              </div>
              <button
                onClick={handleLogout}
                className="bg-white/10 px-3 py-1 rounded hover:bg-white/20 flex items-center gap-2"
              >
                <svg

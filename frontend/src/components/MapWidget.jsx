            ...
            >
                ...
                {locations.map((loc) => {
                    ...
                    if (loc.coordinates?.coordinates && Array.isArray(loc.coordinates.coordinates)) {
                        // GeoJSON [lng, lat]
                        position = { lat: loc.coordinates.coordinates[1], lng: loc.coordinates.coordinates[0] }
                ...
                {selectedLocation && (() => {
                    ...
                    let pos = null
                    if (selectedLocation.coordinates?.coordinates) {
                        pos = { lat: selectedLocation.coordinates.coordinates[1], lng: selectedLocation.coordinates.coordinates[0] }

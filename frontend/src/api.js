...
import { getAccessToken } from "./utils/sessionAuth";
...
// User
export const getUser = (userId_userName) =>
  api.get("/user", { params: { userId_userName } });
...
export const getReturnedBookings = (params) =>
  api.get("/booking/returned", { params });
export const getAdminBookings = (params) =>
  api.get("/booking/admin", { params });
export const getStuckBookings = (params) =>
  api.get("/booking/stuck", { params });

// Cycle
export const getAvailableCycles = (params) =>
  api.get("/cycle/available", { params });
...
// Penalty
export const settlePenalty = (userId, data) =>
  api.patch(`/user/penalty/${userId}`, data);
...
// Stripe / Transactions
export const createPaymentIntent = (bookingId, data) =>
  api.post(`/stripe/${bookingId}/transaction`, data);
export const verifyTransaction = (bookingId, data) =>
  api.post(`/stripe/${bookingId}/transaction/verify`, data);
